...
import com.foodapp.delivery.exception.ResourceNotFoundException;
...
public class DeliveryService {
    ...
    public Mono<OptimizedRoute> optimizeMultipleDeliveries(Long partnerId, List<Delivery> deliveries) {
        ...
        com.foodapp.delivery.dto.googlemaps.Location origin = new com.foodapp.delivery.dto.googlemaps.Location(
                partner.getCurrentLatitude(),
                partner.getCurrentLongitude());
    ...
    private OptimizedRoute convertToOptimizedRoute(com.foodapp.delivery.dto.googlemaps.RoutesResponse response,
        ...
        if (response.getRoutes() != null && !response.getRoutes().isEmpty()) {
            ...
            route.setRoutePolyline(
                    firstRoute.getPolyline() != null ? firstRoute.getPolyline().getEncodedPolyline() : null);
