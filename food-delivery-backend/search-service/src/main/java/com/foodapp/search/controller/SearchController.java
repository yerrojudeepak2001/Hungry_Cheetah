...
import com.foodapp.search.dto.ApiResponse;
...
public class SearchController {
    ...
    public ResponseEntity<ApiResponse<?>> searchRestaurants(
        ...
        return ResponseEntity.ok(ApiResponse.success("Restaurant search results fetched successfully", results));
    }
    ...
    public ResponseEntity<ApiResponse<?>> searchDishes(
        ...
        return ResponseEntity.ok(ApiResponse.success("Dish search results fetched successfully", results));
    }
    ...
    public ResponseEntity<ApiResponse<?>> advancedSearch(@RequestBody AdvancedSearchRequest request) {
        ...
        return ResponseEntity.ok(ApiResponse.success("Advanced search results fetched successfully", results));
    }
    ...
    public ResponseEntity<ApiResponse<?>> searchNearby(
        ...
        return ResponseEntity.ok(ApiResponse.success("Nearby places fetched successfully", results));
    }
    ...
    public ResponseEntity<ApiResponse<?>> getAvailableFilters() {
        ...
        return ResponseEntity.ok(ApiResponse.success("Available filters fetched successfully", filters));
    }
    ...
    public ResponseEntity<ApiResponse<?>> voiceSearch(@RequestBody VoiceSearchRequest request) {
        ...
        return ResponseEntity.ok(ApiResponse.success("Voice search results fetched successfully", results));
    }
    ...
    public ResponseEntity<ApiResponse<?>> imageSearch(@RequestBody ImageSearchRequest request) {
        ...
        return ResponseEntity.ok(ApiResponse.success("Image search results fetched successfully", results));
    }
    ...
    public ResponseEntity<ApiResponse<?>> getSearchHistory(@PathVariable Long userId) {
        ...
        return ResponseEntity.ok(ApiResponse.success("Search history fetched successfully", history));
    }
    ...
    public ResponseEntity<ApiResponse<?>> updateSearchPreferences(
        ...
        return ResponseEntity.ok(ApiResponse.success("Search preferences updated successfully", updated));
    }
}